...
namespace CompilerExample.TypedLang.AST
{
    ...
    class IntModuloExpression : IntExpression
    {
        public Expression<int> Left { get; }
        public Expression<int> Right { get; }

        public IntModuloExpression(Expression<int> left, Expression<int> right)
        {
            Left = left;
            Right = right;
        }
        ...
        public override List<byte> CompileToVMCode()
        {
            ...
            result.Add((byte)OpCodes.Mod);
            return result;
        }
    }

    class FloatModuloExpression : FloatExpression
    {
        public Expression<double> Left { get; }
        public Expression<double> Right { get; }

        public FloatModuloExpression(Expression<double> left, Expression<double> right)
        {
            Left = left;
            Right = right;
        }
